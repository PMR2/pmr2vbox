...
rsync -raAHXx \\
    ...
    --exclude={/root,/proc,/sys,/dev,/mnt,/usr/src,/tmp,var/tmp,var/log,var/log/{apache,tomcat}*,var/lib/portage/distfiles,var/lib/portage/packages,var/cache/{binpkgs,distfiles},var/db/repos,home/*/\\.cache}/* \\
    / /mnt/gentoo/
